...
// Another moderately dangerous page, it lets the user associate the blower 
// to a probe.
...
if ( isset($_GET["id"]) ) {
  ...
  print "Blower ID not specified.";
  exit (2);
}
if ( isset($_GET["controller"]) ) {
  $controller = $_GET["controller"];
} else {
  print "Controller ID not specified.";
  exit (2);
}
...
$json_string = '{"stoker":{"sensors":[{"id":"'.$controller.'","blower":"'.$id.'"}]}}';
